...
train_set = filtered_dataset.shuffle(seed=42).select(range(min(len(filtered_dataset), MAX_TRAIN_SAMPLES)))
test_set = filtered_dataset.shuffle(seed=99).select(range(EVAL_SAMPLES))
