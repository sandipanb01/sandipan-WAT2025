# ============================================================
# XML MT BASELINE INFERENCE — GEMMA-4
# ============================================================
...
OUTPUT_DIR  = "xml_mt_baseline_eval"
...
def main():
    ...
    csv_file = os.path.join(OUTPUT_DIR, "baseline_results.csv")
    ...
    with open(csv_file, "w", newline="") as f:
        ...
        for lp in LANG_PAIRS:
            ...
            preds = evaluate_model(model, tokenizer, src, LANG_NAME_MAP[lp])
