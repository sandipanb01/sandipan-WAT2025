...
# ============================================================
# 3. UTF-8 PRE-FILTER  (runs BEFORE any Python-level filter)
# ============================================================
...
# *before* any HF .filter() callback can see them.  We walk the raw Arrow
# table and collect only the row indices that decode cleanly, then .select()
# them out.  Everything downstream is unchanged.
...
# ============================================================
# 5. LOAD + DYNAMIC SPLIT WITH SAMPLE LIMITS
# ============================================================
...
print("Scanning for invalid UTF-8 rows …")
valid_idx = get_valid_indices(raw_ds)
print(f"  Kept {len(valid_idx)} / {len(raw_ds)} rows after UTF-8 pre-filter.")
raw_ds = raw_ds.select(valid_idx)

# ---- SAFE FILTERING: scalar-only, no vectorised decode ----
...
# ============================================================
# 8. SANITY CHECK CALLBACK FOR TRAINING
# ============================================================
...
# ============================================================
# 10. TRAINING & VALIDATION LOSS ANALYSIS
# ============================================================
