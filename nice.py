# -*- coding: utf-8 -*-
"""seg fault fix fine tune.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vAd8wY6IB7xyGTWoblwupBcXEzUfWBeJ
"""
...
TRAIN_SAMPLES_PER_PAIR = 20000
EVAL_SAMPLES_PER_PAIR = 1000
...
# ------------------------------
def load_streaming_dataset(tokenizer, data_dir="train",samples_per_pair=50000 , one_shot=True):
    examples = []
    ...
    for lang in INDIAN_LANGS:
        ...
        if one_shot:
            ...
            ds = load_dataset("ai4bharat/Pralekha", data_dir=data_dir, split="train", streaming=True)
            count = 0
            for row in ds:
...
def train_model():
    ...
    training_data = load_streaming_dataset(tokenizer, data_dir="train", samples_per_pair=TRAIN_SAMPLES_PER_PAIR, one_shot=True)
    eval_data = load_streaming_dataset(tokenizer, data_dir="dev", samples_per_pair=EVAL_SAMPLES_PER_PAIR, one_shot=True)
...
# ------------------------------
def evaluate_model(model, tokenizer, eval_data, save_jsonl=True, jsonl_path=OUTPUT_DIR/"eval_predictions.jsonl", max_new_tokens=512):
...
# ------------------------------
def plot_langwise_chrf(jsonl_path= OUTPUT_DIR/"eval_predictions.jsonl"):
    data = []
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR /"langwise_chrf.png")
    plt.show()
...
if __name__ == "__main__":
    ...
    plot_langwise_chrf(OUTPUT_DIR/"eval_predictions.jsonl")